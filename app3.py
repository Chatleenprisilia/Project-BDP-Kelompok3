...
def get_loc(kota = "Bitung"):
    response = requests.get("https://api.openweathermap.org/geo/1.0/direct?q="+kota+",ID&appid=3952cfa877429d1ad35c176b7a23a49d")
...
def get_weather(lat,lon):
    response = requests.get("https://api.openweathermap.org/data/2.5/weather?lat="+lat+"&lon="+lon+"&units=metric&appid=3952cfa877429d1ad35c176b7a23a49d&lang=id")
    parse_json = json.loads(response.text)
